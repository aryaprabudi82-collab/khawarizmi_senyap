...
/**
 * Bagan akun minimum yang dibutuhkan PostingService: satu akun aktif per
 * jenis (kas, piutang, pendapatan). Bukan bagan akun RSP UI yang sebenarnya —
 * itu perlu disusun bersama bagian keuangan sebelum dipakai melayani pasien.
 */
