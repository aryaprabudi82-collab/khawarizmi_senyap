...
@section('title', 'Dapur — Barang Dapur')
@section('breadcrumb', 'Konteks kitchen')
@section('heading', 'Barang, Kategori & Suplier Dapur')
...
<div class="row g-3">
  <div class="col-12 col-lg-8">
    <div class="card mb-3">
      ...
      <div class="card-body border-top">
        <form method="POST" action="{{ route('kitchen.barang.simpan') }}" class="row g-2">
          @csrf
          ...
          <div class="col-6 col-md-2"><input type="text" name="unit_of_measure" class="form-control form-control-sm" placeholder="Satuan (kg, liter)" required></div>
  ...
  <div class="col-12 col-lg-4">
    <div class="card mb-3">
      ...
      <div class="card-body border-top">
        <form method="POST" action="{{ route('kitchen.kategori.simpan') }}" class="row g-2">
          @csrf
    ...
    <div class="card">
      ...
      <div class="card-body border-top">
        <form method="POST" action="{{ route('kitchen.suplier.simpan') }}" class="row g-2">
          @csrf
          <div class="col-5"><input type="text" name="code" class="form-control form-control-sm" placeholder="Kode" required></div>
          <div class="col-5"><input type="text" name="name" class="form-control form-control-sm" placeholder="Nama" required></div>
          <div class="col-2"><button class="btn btn-sm btn-outline-primary w-100">+</button></div>
...
@foreach ($barang as $b)
  <div class="modal fade" id="edit-barang-{{ $b->id }}" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <form class="modal-content" method="POST" action="{{ route('kitchen.barang.perbarui', $b) }}">
        @csrf
  ...
  <div class="modal fade" id="masuk-{{ $b->id }}" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <form class="modal-content" method="POST" action="{{ route('kitchen.barang.masuk', $b) }}">
        @csrf
  ...
  <div class="modal fade" id="opname-{{ $b->id }}" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <form class="modal-content" method="POST" action="{{ route('kitchen.barang.opname', $b) }}">
        @csrf
