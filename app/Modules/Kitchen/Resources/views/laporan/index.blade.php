...
@section('title', 'Dapur — Riwayat & Sirkulasi')
@section('breadcrumb', 'Konteks kitchen')
@section('heading', 'Riwayat & Sirkulasi Barang Dapur')

@section('actions')
  <a href="{{ route('kitchen.opname.index') }}" class="btn btn-link">Stok Opname &rarr;</a>
@endsection
...
<div class="card mb-3">
  ...
  <div class="card-body">
    <form method="GET" action="{{ route('kitchen.laporan.index') }}" class="row g-2">
...
<div class="card">
  <div class="card-header">
    ...
    <form method="GET" action="{{ route('kitchen.laporan.index') }}" class="ms-auto">
