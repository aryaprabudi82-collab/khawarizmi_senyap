...
@section('title', 'Dapur — Stok Opname')
@section('breadcrumb', 'Konteks kitchen')
@section('heading', 'Stok Opname Barang Dapur')

@section('actions')
  <a href="{{ route('kitchen.laporan.index') }}" class="btn btn-link">&larr; Riwayat &amp; Sirkulasi</a>
@endsection
...
<div class="card mb-3">
  ...
  <div class="card-body">
    <form method="POST" action="{{ route('kitchen.opname.simpan') }}" class="row g-2">
      @csrf
      ...
      <tbody>
        @forelse ($opname as $o)
          <tr>
            ...
            <td><a href="{{ route('kitchen.opname.show', $o) }}" class="btn btn-sm btn-outline-primary">Detail</a></td>
          </tr>
        @empty
