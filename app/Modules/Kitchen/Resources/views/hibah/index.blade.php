...
@section('title', 'Dapur — Hibah Barang')
@section('breadcrumb', 'Konteks kitchen')
@section('heading', 'Hibah Barang Dapur')

@section('actions')
  <a href="{{ route('kitchen.po.index') }}" class="btn btn-link">&larr; Pengadaan</a>
@endsection
...
<div class="row g-3 mb-3">
  <div class="col-12 col-lg-4">
    <div class="card">
      ...
      <div class="card-body border-top">
        <form method="POST" action="{{ route('kitchen.hibah.donor.simpan') }}" class="row g-2">
          @csrf
  ...
  <div class="col-12 col-lg-8">
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('kitchen.hibah.simpan') }}">
          @csrf
