...
@section('title', 'Dapur — Penerimaan Barang')
@section('breadcrumb', 'Konteks kitchen')
@section('heading', 'Penerimaan Barang Dapur')
      ...
      <tbody>
        @forelse ($penerimaan as $r)
          <tr>
            ...
            <td>
              @can('verifikasi_penerimaan_dapur')
  ...
  @if ($r->status !== 'terverifikasi')
    <div class="modal fade" id="verifikasi-{{ $r->id }}" tabindex="-1">
      <div class="modal-dialog modal-dialog-centered">
        <form class="modal-content" method="POST" action="{{ route('kitchen.penerimaan.verifikasi', $r) }}">
          @csrf
