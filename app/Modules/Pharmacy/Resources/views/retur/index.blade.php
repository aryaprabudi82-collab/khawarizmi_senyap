...
@section('title', 'Farmasi — Retur Ke Suplier')
@section('breadcrumb', 'Konteks pharmacy')
@section('heading', 'Retur Obat, Alkes & BHP Ke Suplier')
...
<div class="card mb-3">
  ...
  <div class="card-body">
    <form method="POST" action="{{ route('pharmacy.retur.simpan') }}">
      @csrf
      ...
      <div class="table-responsive mb-2">
        <table class="table table-sm">
          <thead><tr><th>Obat/Alkes/BHP</th><th style="width:150px">No. Batch</th><th style="width:120px">Jumlah</th></tr></thead>
          <tbody>
            @foreach ($obat as $o)
              <tr>
                <td>
...
<div class="card">
  ...
  <div class="table-responsive">
    <table class="table table-vcenter card-table">
      <thead><tr><th>No. Retur</th><th>Suplier</th><th>Obat/BHP</th><th>Alasan</th><th>Status</th><th class="w-1"></th></tr></thead>
      <tbody>
        @forelse ($retur as $r)
          <tr>
            ...
            <td>
              @if ($r->status === 'diajukan')
                <form method="POST" action="{{ route('pharmacy.retur.selesai', $r) }}" onsubmit="return confirm('Selesaikan retur ini? Stok batch terkait akan dikurangi.')">
                  @csrf
