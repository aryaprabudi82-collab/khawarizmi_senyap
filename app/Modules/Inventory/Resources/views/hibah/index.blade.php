...
@section('title', 'Logistik — Hibah Barang')
@section('breadcrumb', 'Konteks inventory')
@section('heading', 'Hibah Barang Non-Medis')

@section('actions')
  <a href="{{ route('inventory.po.index') }}" class="btn btn-link">&larr; Pengadaan</a>
@endsection
...
<div class="row g-3 mb-3">
  <div class="col-12 col-lg-4">
    <div class="card">
      ...
      <div class="card-body border-top">
        <form method="POST" action="{{ route('inventory.hibah.donor.simpan') }}" class="row g-2">
          @csrf
  ...
  <div class="col-12 col-lg-8">
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="{{ route('inventory.hibah.simpan') }}">
          @csrf
          ...
          <div class="table-responsive mb-2">
            <table class="table table-sm">
              <thead><tr><th>Barang</th><th style="width:110px">Jumlah</th></tr></thead>
              <tbody>
                @foreach ($barang as $b)
                  <tr>
                    <td>
          ...
          <tr>
            ...
            <td class="text-secondary small">
              @foreach ($h->items as $baris)
                {{ $baris->item_name }} ({{ rtrim(rtrim(number_format((float) $baris->quantity, 2, ',', '.'), '0'), ',') }})@if (!$loop->last), @endif
              @endforeach
            </td>
