...
@section('title', 'Logistik — Rekap')
@section('breadcrumb', 'Konteks inventory')
@section('heading', 'Rekap Logistik Non-Medis')

@section('actions')
  <a href="{{ route('inventory.hibah.index') }}" class="btn btn-link">Hibah &rarr;</a>
@endsection
...
<div class="card mb-3">
  ...
  <div class="card-body">
    <form method="GET" action="{{ route('inventory.rekap.index') }}" class="row g-2">
      ...
      <div class="col-6 col-md-3">
        <label class="form-label">Pengeluaran Harian — Tanggal</label>
...
<div class="row g-3 mb-3">
  ...
  <div class="col-12 col-lg-4">
    <div class="card">
      <div class="card-header"><h3 class="card-title">Pengeluaran Harian</h3></div>
      <div class="card-body">
