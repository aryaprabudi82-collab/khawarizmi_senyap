...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        ...
        'lama_pelayanan_pasien', 'rekap_jm_dokter', 'rl4a', 'rekap_kunjungan', 'rekap_pembayaran_ralan', 'rekap_obat_pasien', 'rekap_pengadaan_dapur', 'resep_luar', 'resep_obat', 'retur_ke_suplier', 'retur_obat_ranap', 'ringkasan_tindakan', 'rujukan_keluar', 'satu_sehat_kirim_condition', 'satu_sehat_kirim_encounter',
