...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        ...
        'parkir_in', 'parkir_jenis', 'pembayaran_ralan', 'pembayaran_ranap', 'potongan_biaya', 'pemeliharaan_inventaris', 'pemeriksaan_lab_pa', 'penerimaan_aset_inventaris', 'penerimaan_non_medis', 'penjualan_obat', 'pengadaan_aset_inventaris', 'pengadaan_obat', 'pengajuan_asetinventaris', 'pengajuan_barang_dapur', 'pengajuan_barang_medis', 'pengajuan_barang_nonmedis', 'pengajuan_cuti', 'pengeluaran_stok_apotek', 'hutang_obat', 'validasi_tagihan_hutang_obat', 'penagihan_piutang_pasien', 'validasi_penagihan_piutang', 'akun_rekening', 'posting_jurnal', 'piutang_jasa_perusahaan', 'pengeluaran', 'pendapatan_per_akun', 'pendapatan_per_akun_closing', 'pengumuman_epasien', 'penyakit_ralan', 'piutang_pasien',
