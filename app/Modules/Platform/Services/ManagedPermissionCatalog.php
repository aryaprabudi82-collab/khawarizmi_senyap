...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        ...
        'parkir_in', 'parkir_jenis', 'pembayaran_ralan', 'pembayaran_ranap', 'potongan_biaya', 'pemeliharaan_inventaris', 'pemeriksaan_lab_pa', 'penerimaan_aset_inventaris', 'penerimaan_non_medis', 'penjualan_obat', 'pengadaan_aset_inventaris', 'pengadaan_obat', 'pengajuan_asetinventaris', 'pengajuan_barang_dapur', 'pengajuan_barang_medis', 'pengajuan_barang_nonmedis', 'pengajuan_cuti', 'pengeluaran_stok_apotek', 'hutang_obat', 'validasi_tagihan_hutang_obat', 'penagihan_piutang_pasien', 'validasi_penagihan_piutang', 'akun_rekening', 'pengajuan_biaya', 'persetujuan_pengajuan_biaya', 'validasi_persetujuan_pengajuan_biaya', 'posting_jurnal', 'piutang_jasa_perusahaan', 'pembayaran_briva', 'set_tarif_online', 'pengeluaran', 'pendapatan_per_akun', 'pendapatan_per_akun_closing', 'pengumuman_epasien', 'penyakit_ralan', 'piutang_pasien',
        ...
        'koleksi_perpustakaan', 'kategori_perpustakaan', 'inventaris_perpustakaan', 'toko_barang', 'stok_opname_toko', 'toko_pengadaan_barang', 'toko_penjualan',
        'zis_kategori_asnaf_penerima_dankes', 'zis_pengeluaran_penerima_dankes', 'aplikasi', 'ruang_ok', 'setup_pjlab', 'display', 'display_apotek', 'closing_kasir', 'anggota_perpustakaan', 'peminjaman_perpustakaan', 'set_peminjaman_perpustakaan', 'permintaan_ranap', 'sirkulasi_cssd', 'sensus_harian_ralan', 'sisa_stok', 'skp_penilaian', 'stok_opname_logistik', 'stok_opname_obat', 'suplier_inventaris', 'surat_keterangan_sehat', 'surat_masuk', 'surat_permohonan_privasi', 'surat_pemesanan_dapur', 'surat_pemesanan_non_medis',
