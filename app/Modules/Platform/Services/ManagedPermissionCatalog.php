...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        ...
        'pembayaran_ralan', 'pemeriksaan_lab_pa', 'penerimaan_aset_inventaris', 'penerimaan_non_medis', 'penjualan_obat', 'pengadaan_aset_inventaris', 'pengadaan_obat', 'pengajuan_asetinventaris', 'pengajuan_barang_dapur', 'pengajuan_barang_medis', 'pengajuan_barang_nonmedis', 'pengajuan_cuti', 'pengeluaran_stok_apotek', 'pengumuman_epasien',
