...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        ...
        'igd', 'insiden_keselamatan_pasien', 'inventaris_inventaris', 'ipsrs_barang', 'ipsrs_pengadaan_barang', 'ipsrs_returbeli', 'ipsrs_riwayat_barang', 'jadwal_pegawai', 'jenis_cidera_k3rstahun', 'layanan_program_kfr', 'limbah_b3_medis',
        'hibah_obat_bhp', 'keuntungan_penjualan', 'mapping_poli_bpjs', 'mutasi_barang', 'obat', 'operasi', 'pasien', 'pcra_icra_pengkajian_risiko_prakonstruksi', 'pegawai_user',
        ...
        'permintaan_ranap', 'sirkulasi_cssd', 'sisa_stok', 'skp_penilaian', 'stok_opname_logistik', 'stok_opname_obat', 'surat_keterangan_sehat', 'surat_masuk', 'surat_pemesanan_non_medis',
        'tarif_ralan', 'telaah_resep', 'tindakan_ranap', 'utd_pendonor', 'utd_penyerahan_darah', 'utd_stok_darah',
        'user', 'verifikasi_penerimaan_farmasi', 'verifikasi_penerimaan_logistik',
    ];
