...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        'audit_kepatuhan_apd', 'barcoderalan', 'barcoderanap', 'bayar_pemesanan_obat', 'bayar_piutang', 'beri_obat', 'booking_mcu_perusahaan', 'booking_operasi', 'bpjs_cek_kartu', 'bpjs_sep', 'dapur_barang', 'dapur_opname', 'dapur_pemesanan', 'dapur_pembelian', 'dapur_returbeli', 'dapur_riwayat_barang', 'deposit_pasien', 'diet_pasien',
        ...
        'permintaan_ranap', 'sirkulasi_cssd', 'sisa_stok', 'skp_penilaian', 'stok_opname_logistik', 'stok_opname_obat', 'surat_keterangan_sehat', 'surat_masuk', 'surat_pemesanan_dapur', 'surat_pemesanan_non_medis',
