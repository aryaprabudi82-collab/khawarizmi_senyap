...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        ...
        'rekap_jm_dokter', 'rekap_kunjungan', 'rekap_obat_pasien', 'rekap_pengadaan_dapur', 'resep_luar', 'resep_obat', 'retur_ke_suplier', 'retur_obat_ranap', 'rujukan_keluar', 'satu_sehat_kirim_condition', 'satu_sehat_kirim_encounter',
