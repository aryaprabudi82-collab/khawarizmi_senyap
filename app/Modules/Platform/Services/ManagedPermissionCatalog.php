...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        'audit_kepatuhan_apd', 'barcoderalan', 'barcoderanap', 'bayar_pemesanan_obat', 'bayar_piutang', 'beri_obat', 'booking_mcu_perusahaan', 'booking_operasi', 'bpjs_cek_kartu', 'bpjs_sep', 'dapur_barang', 'dapur_pemesanan', 'dapur_pembelian', 'dapur_returbeli', 'deposit_pasien', 'diet_pasien',
