...
class ManagedPermissionCatalog
{
    ...
    private const MANAGED_CODES = [
        ...
        'pembayaran_ralan', 'pemeriksaan_lab_pa', 'pengadaan_obat', 'pengajuan_barang_medis', 'pengajuan_barang_nonmedis', 'pengajuan_cuti', 'pengeluaran_stok_apotek', 'pengumuman_epasien',
        ...
        'rekap_kunjungan', 'resep_luar', 'resep_obat', 'retur_ke_suplier', 'rujukan_keluar', 'satu_sehat_kirim_condition', 'satu_sehat_kirim_encounter',
